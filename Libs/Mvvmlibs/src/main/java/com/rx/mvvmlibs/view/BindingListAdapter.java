...
public abstract class BindingListAdapter<Data>
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Holder(onCreateBinding(
                LayoutInflater.from(parent.getContext()),parent,viewType).getRoot());
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        onBinding(((Holder)holder).binding,mPosition,data);
    ...
    public abstract ViewDataBinding onCreateBinding(LayoutInflater inflater,ViewGroup parent, int viewType);
